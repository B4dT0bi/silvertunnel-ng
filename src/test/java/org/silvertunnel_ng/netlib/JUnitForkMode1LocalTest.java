...
/**
 * JUnit test to test the JUnit execution environment: each test case class
 * should be executed in a separate JVM. This will be enforced in ant task
 * junit/batchtest with fork="yes" and (default) forkmode="perTest".
 * 
...
{
	/** */
	private static final Logger LOG = LoggerFactory.getLogger(JUnitForkMode1LocalTest.class);

	/**
	 * global flag: this may not be set by any other test case class in the JVM
