...
public final class NtpMessage
{
	 ...
	 */
	public static void encodeTimestamp(final byte[] array, final int pointer,
			double timestamp)
	{
	 ...
	 */
	public static String referenceIdentifierToString(final byte[] ref, final short stratum,
			final byte version)
	{
		// From the RFC 2030:
	...
	/**
	 * @param leapIndicator the leapIndicator to set
	 */
	...
	/**
	 * @param rootDelay the rootDelay to set
	 */
	...
	/**
	 * @param rootDispersion the rootDispersion to set
	 */
	...
	/**
	 * @param originateTimestamp the originateTimestamp to set
	 */
	public void setOriginateTimestamp(double originateTimestamp)
	{
	...
	/**
	 * @param transmitTimestamp the transmitTimestamp to set
	 */
	public void setTransmitTimestamp(double transmitTimestamp)
	{
