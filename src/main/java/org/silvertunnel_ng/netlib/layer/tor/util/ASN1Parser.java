...
/**
 * A very minimal ASN.1 BER parser which only supports the ASN.1 object types
 * needed for parsing encoded RSA public keys.
 */
public class ASN1Parser
{
	 ...
	 * buffer. Increment position pointer of data buffer to skip over these
	 * bytes.
	 */
